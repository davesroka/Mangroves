...
import com.robotfactorial.mangroves.activities.BaseMapViewActivity;
...
import com.robotfactorial.mangroves.models.ViewReportModel;
...
import com.robotfactorial.mangroves.views.ViewReportView;
...
public class ViewReportActivity extends
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.robotfactorial.mangroves.MapUserLocation#locationChanged(double,
	 * double)
	 */
	@Override
