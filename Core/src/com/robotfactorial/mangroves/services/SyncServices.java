...
package com.robotfactorial.mangroves.services;
...
public abstract class SyncServices extends IntentService {
	...
	public static String SYNC_SERVICES_ACTION = "com.robotfactorial.mangroves.services.sync";
	
	public static String UPLOAD_CHECKIN_SERVICES_ACTION = "com.robotfactorial.mangroves.services.uploadcheckin";
	
	public static String FETCH_CHECKIN_SERVICES_ACTION = "com.robotfactorial.mangroves.services.fetchcheckin";
	
	public static String FETCH_CHECKIN_COMMENTS_SERVICES_ACTION = "com.robotfactorial.mangroves.services.fetchcheckincomments";
	
	public static String FETCH_REPORT_COMMENTS_SERVICES_ACTION = "com.robotfactorial.mangroves.services.fetchreportcomments";
	
	public static String UPLOAD_COMMENT_SERVICES_ACTION = "com.robotfactorial.mangroves.services.uploadcomment";
