 ...
 **
 **/
package com.robotfactorial.mangroves.database;
...
import com.robotfactorial.mangroves.entities.Comment;
...
public class CommentDao extends DbContentProvider implements ICommentDao,
	 ...
	 * 
	 * @see
	 * com.robotfactorial.mangroves.database.ICommentDao#addComment(java.util.List)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.robotfactorial.mangroves.database.ICommentDao#addComment(com.ushahidi
	 ...
	 * 
	 * @see
	 * com.robotfactorial.mangroves.database.ICommentDao#fetchCheckinComment(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.robotfactorial.mangroves.database.ICommentDao#fetchReportComment(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.robotfactorial.mangroves.database.ICommentDao#updateCheckinByReportId
	 * (int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.robotfactorial.mangroves.database.ICommentDao#updateCheckinByCheckinId
	 * (int)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.robotfactorial.mangroves.database.ICommentDao#deleteAllComment()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.robotfactorial.mangroves.database.ICommentDao#deleteCommentByReportId
	 * (int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.robotfactorial.mangroves.database.ICommentDao#deleteCommentByCheckinId
	 * (int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.robotfactorial.mangroves.database.DbContentProvider#cursorToEntity(android
	 * .database.Cursor)
	 */
