...
public class MediaDao extends DbContentProvider implements IMediaDao,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.robotfactorial.mangroves.database.IMediaDao#deleteAllMedia()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.robotfactorial.mangroves.database.IMediaDao#addMedia(java.util.List)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.robotfactorial.mangroves.database.IMediaDao#addMedia(com.ushahidi.android
	 * .app.entities.Media)
	 */
	@Override
