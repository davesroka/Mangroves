...
package com.qfi.mangroves.adapters;
...
public class ListPhotoAdapter extends BaseListAdapter<Photo> {
	...
	class Widgets extends com.qfi.mangroves.views.View {
	 ...
	 * 
	 * @see
	 * com.qfi.mangroves.adapters.BaseListAdapter#refresh(android.content
	 * .Context)
	 */
	@Override
	public void refresh() {
