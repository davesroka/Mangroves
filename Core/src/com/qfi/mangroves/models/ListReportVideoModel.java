...
import com.qfi.mangroves.entities.Video;
...
public class ListReportVideoModel extends Model {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.qfi.mangroves.models.Model#load(android.content.Context)
	 */
	@Override
	public boolean load() {
		return false;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.qfi.mangroves.models.Model#save(android.content.Context)
	 */
	@Override
	public boolean save() {
