...
import com.qfi.mangroves.entities.Media;
...
public class MediaDao extends DbContentProvider implements IMediaDao,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.qfi.mangroves.database.IMediaDao#deleteAllMedia()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.qfi.mangroves.database.IMediaDao#addMedia(java.util.List)
	 */
	 ...
	 * 
	 * @see
	 * com.qfi.mangroves.database.IMediaDao#addMedia(com.ushahidi.android
	 * .app.entities.Media)
	 */
