...
import com.qfi.mangroves.entities.OfflineReport;
...
public class OfflineReportDao extends DbContentProvider implements IOfflineReportDao,
     ...
     * (non-Javadoc)
     * @see
     * com.qfi.mangroves.database.IOfflineReportDao#fetchAllOfflineIncidents
     * ()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * com.qfi.mangroves.database.IOfflineReportDao#deleteAllOfflineReport
     * ()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * com.qfi.mangroves.database.IOfflineReportDao#addOfflineReport(
     * com.qfi.mangroves.entities.OfflineReport)
     */
    @Override
