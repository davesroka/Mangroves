 ...
 **
 **/
package com.qfi.mangroves.database;
...
import com.qfi.mangroves.entities.Comment;
...
public class CommentDao extends DbContentProvider implements ICommentDao,
	 ...
	 * 
	 * @see
	 * com.qfi.mangroves.database.ICommentDao#addComment(java.util.List)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.qfi.mangroves.database.ICommentDao#addComment(com.ushahidi
	 ...
	 * 
	 * @see
	 * com.qfi.mangroves.database.ICommentDao#fetchCheckinComment(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.qfi.mangroves.database.ICommentDao#fetchReportComment(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.qfi.mangroves.database.ICommentDao#updateCheckinByReportId
	 * (int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.qfi.mangroves.database.ICommentDao#updateCheckinByCheckinId
	 * (int)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.qfi.mangroves.database.ICommentDao#deleteAllComment()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.qfi.mangroves.database.ICommentDao#deleteCommentByReportId
	 * (int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.qfi.mangroves.database.ICommentDao#deleteCommentByCheckinId
	 * (int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.qfi.mangroves.database.DbContentProvider#cursorToEntity(android
	 * .database.Cursor)
	 */
