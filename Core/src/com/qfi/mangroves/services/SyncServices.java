...
package com.qfi.mangroves.services;
...
public abstract class SyncServices extends IntentService {
	...
	public static String SYNC_SERVICES_ACTION = "com.qfi.mangroves.services.sync";
	
	public static String UPLOAD_CHECKIN_SERVICES_ACTION = "com.qfi.mangroves.services.uploadcheckin";
	
	public static String FETCH_CHECKIN_SERVICES_ACTION = "com.qfi.mangroves.services.fetchcheckin";
	
	public static String FETCH_CHECKIN_COMMENTS_SERVICES_ACTION = "com.qfi.mangroves.services.fetchcheckincomments";
	
	public static String FETCH_REPORT_COMMENTS_SERVICES_ACTION = "com.qfi.mangroves.services.fetchreportcomments";
	
	public static String UPLOAD_COMMENT_SERVICES_ACTION = "com.qfi.mangroves.services.uploadcomment";
