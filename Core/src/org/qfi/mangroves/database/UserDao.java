...
import org.qfi.mangroves.entities.User;
...
public class UserDao extends DbContentProvider implements IUserSchema, IUserDao {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.qfi.mangroves.database.IUserDao#fetchUsersById(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.qfi.mangroves.database.IUserDao#addUser(com.ushahidi.android
	 * .app.entities.User)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.qfi.mangroves.database.IUserDao#addUser(java.util.List)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.qfi.mangroves.database.IUserDao#deleteAllUsers()
	 */
	@Override
